  ...
  <view class="container">
    ...
    <tui-modal :show="showNoVip" :custom="true" @cancel="hideNoVipModal">
      <view class="tui-modal-custom">
        ...
        <view class="tui-modal-custom-text">非VIP用户步数不能超过2万</view>
        <tui-button height="72rpx" :size="28" type="danger" shape="circle" @click="goOpenVip">去开通VIP</tui-button>
      </view>
    </tui-modal>
    <!--居中消息-->
...
import { ChangeStepResultModel, ChangeStepModel } from '@/models/apiModel';
